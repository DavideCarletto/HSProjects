...
public class TestArrays {
	...
	public ArrayList<Studente> creaArrays() {
		...
		studenti4.put(""+studenteRiferimento.getMetricola(), studenteRiferimento);
		studenti5.put(""+studenteRiferimento.getMetricola(), studenteRiferimento);
		studenti6.put(""+studenteRiferimento.getMetricola(), studenteRiferimento);
	...
	public void testaHashTable() {
		long startTime = System.currentTimeMillis();
		studenti4.get(""+studenteRiferimento.getMetricola());
		long elapsedTime = System.currentTimeMillis() - startTime;
	...
	public void testaHashMap() {
		long startTime = System.currentTimeMillis();
		studenti5.get(""+studenteRiferimento.getMetricola());
		long elapsedTime = System.currentTimeMillis() - startTime;
	...
	public void testaTreeMap() {
		long startTime = System.currentTimeMillis();
		studenti6.get(""+studenteRiferimento.getMetricola());
		long elapsedTime = System.currentTimeMillis() - startTime;
